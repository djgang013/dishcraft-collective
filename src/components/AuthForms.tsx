  ...
  return (
    ...
    >
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-muted-foreground">Sign in to your SmartRecipe account</p>
      </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-muted-foreground">Join SmartRecipe to manage and share recipes</p>
      </div>
